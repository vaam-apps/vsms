...
//! `app/sms-gateway/tests/m1_acceptance_gate_live_postgres.rs`, which
...
//! `crates/sms-api/examples/send_test_message.rs` is the cautionary
...
/// the same instant. See `crates/sms-worker/tests/claim_live_postgres.rs`'s
