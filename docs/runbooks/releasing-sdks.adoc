...
* *Node.js SDK*: `@vaam-apps/vsms-node` on https://www.npmjs.com/package/@vaam-apps/vsms-node[npm]
...
=== 2. Node.js SDK (`@vaam-apps/vsms-node`)
 ...
 ** Verify `publish-node-sdk` completes and package is live on `+https://www.npmjs.com/package/@vaam-apps/vsms-node+`.
