...
| **3 — Operate it** | M4, M6 | Can a human run this without a database console, and does it satisfy Cameroonian law? | M6 **done** (9/9, gate passed). M4 **12/20** — now the largest remaining block, and the four screens left (#52, #53, #55, #58) were all gated on #211 until it landed |
