...
| **3 — Operate it** | M4, M6 | Can a human run this without a database console, and does it satisfy Cameroonian law? | M6 **done** (9/9, gate passed). M4 **14/20** — #52 (apps and service-account clients) and #58 (opt-outs, users/roles, audit log, settings) both closed together; #53/#55 remain, both unblocked by #211 the same way #52/#58 were |
