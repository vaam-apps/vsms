...
//     (`packages/ui/src/components/bespoke/state-timeline.tsx`) renders
...
//     persisted, per `crates/sms-api/src/dlr.rs`'s own module doc) is
...
// `crates/sms-api/src/dlr.rs::next_state` shows a `DeliveryOutcome::Failed`
