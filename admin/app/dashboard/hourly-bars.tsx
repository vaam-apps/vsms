...
// library exists anywhere in this workspace (`admin/package.json`,
// `packages/ui/package.json` — checked before writing this rather than
...
// every other screen already uses (`packages/ui/src/styles/theme.css`).
//
