...
- **Rust** for the gateway and worker, on [CrateStack](https://cratestack.dev/) `=0.8.3` — schema-first, `.cstack` generates the model layer, policies, audit, events and REST surface. Pinned exactly, and the installed CLI must match the pin; see `AGENTS.md`.
