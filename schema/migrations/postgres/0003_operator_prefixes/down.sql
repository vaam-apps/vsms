...
ALTER TABLE operator_prefixs DROP CONSTRAINT operator_prefixs_source_enum_check;

ALTER TABLE operator_prefixs DROP CONSTRAINT operator_prefixs_operator_enum_check;
...
DROP INDEX operator_prefixs_prefix_key;
