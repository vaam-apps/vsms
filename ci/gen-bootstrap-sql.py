import re, sys
ts = "App AppClient OauthClient OauthSigningKey ClientAssertion SenderId SenderIdRegistration Provider Route OperatorPrefixRule Message MessagePart Job OptOut WebhookEndpoint User Role".split()
