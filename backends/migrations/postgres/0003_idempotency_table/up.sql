...
-- bookkeeping, not part of `schemas/vsms.cstack` and never touched by
...
-- database path), `backends/crates/sms-test-support` (the live-suite harness), and
-- `backends/apps/sms-migrate` (the real deploy path) — has a Rust runtime available
...
-- `backends/migrations/postgres/*/up.sql`, with no special-cased extra step
-- for this file any more.
--
-- `backends/crates/sms-api/tests/idempotency_table_ddl_matches_cratestack.rs`
