...
use sms_api::schema::{
    ...
    SenderIdRegistrationStatus, procedures::ProcedureRegistry, procedures::send_message,
};
...
/// correct (`backends/crates/sms-api/src/consent.rs`'s own unit tests already cover
