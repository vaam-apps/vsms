...
/// metric (`sms_sm001_total`, the first, is proven in `backends/crates/sms-api/src/
...
/// `backends/crates/sms-worker/src/lib.rs` would leave `RoleLease` itself completely
