...
/// removing (see `backends/crates/sms-worker/tests/dispatch_live_postgres.rs`'s own
...
/// long-lived demo/dev process (`backends/apps/sms-fake-orange`) that must never run
