...
console.log(" is unbuilt, and the signature this receiver verifies (#41) is");
console.log(" not implemented or fully specified. See README.md and");
console.log(" src/signature.ts for exactly what that means here.");
console.log("------------------------------------------------------------");
