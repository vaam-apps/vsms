...
That is the complete list, and `ci/assert-no-raw-sqlx.sh` enforces it. Adding an eighth entry should feel like a design decision, because it is one — put the reasoning in the PR.
