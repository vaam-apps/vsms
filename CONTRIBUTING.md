...
That is the complete list, and `ci/assert-no-raw-sqlx.sh` enforces it. Adding a seventh entry should feel like a design decision, because it is one — put the reasoning in the PR.
