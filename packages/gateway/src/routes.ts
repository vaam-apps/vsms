...
/** `DELETE /routes/{id}`. **Stale as of the cratestack 0.7.16 bump: this
 * now needs `If-Match` and does not send one — see `rest.ts`'s own
 * `deleteResource` doc for the mechanism and why it isn't fixed here.**
